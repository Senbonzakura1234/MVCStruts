                        ...
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                            <div class="mdc-card p-0">
                                ...
                                <div class="px-5 text-right">
                                    <a href="<s:url namespace="/publisher" action="createGet"/>"
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <s:iterator value="publishers">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<s:url namespace="/publisher" action="updateStatusGet">
                                                    ...
                                                    <a href="<s:url namespace="/publisher" action="updateGet">
                                                      <s:param name="id"><s:property value="id" /></s:param>
                                                    </s:url>"
