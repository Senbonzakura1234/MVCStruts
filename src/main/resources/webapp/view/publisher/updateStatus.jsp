                ...
                <div class="mdc-layout-grid">
                    <div class="mdc-layout-grid__inner">
                        <div class="mdc-layout-grid__cell--span-4 mdc-layout-grid__cell--span-6-desktop stretch-card">
                            <s:form method="POST" class="mdc-card" namespace="/publisher" action="updateStatusPost" theme="simple">
                                    ...
                                    <div class="mdc-layout-grid__inner">
                                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                                            <div class="mdc-select demo-width-class" data-mdc-auto-init="MDCSelect">
                                                <s:hidden name="status" theme="simple"/>
                                                <i class="mdc-select__dropdown-icon"></i>
                                                <div class="mdc-select__selected-text"></div>
                                                <div class="mdc-select__menu mdc-menu-surface demo-width-class">
                                                    <ul class="mdc-list">
                                                        <s:iterator value="statusSelectList">
                                                            <li class="mdc-list-item
                                                                <s:if test='%{selected==true}'>mdc-list-item--selected</s:if>"
                                                                data-value="<s:property value="name" />"
