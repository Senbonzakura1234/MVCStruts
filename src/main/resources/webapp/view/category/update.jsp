                ...
                <div class="mdc-layout-grid">
                    <div class="mdc-layout-grid__inner">
                        <div class="mdc-layout-grid__cell--span-4 mdc-layout-grid__cell--span-6-desktop stretch-card">
                            <s:form method="POST" class="mdc-card" namespace="/category" action="updatePost" theme="simple">
                                        ...
                                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                                            <div class="mdc-text-field mdc-text-field--outlined">
                                                <s:textfield name="name" theme="simple"
                                                             ...
                                                             id="text-field-hero-inputS"/>
                                                <div class="mdc-notched-outline">
                                                    <div class="mdc-notched-outline__leading"></div>
                                                    <div class="mdc-notched-outline__notch">
                                                        <label for="text-field-hero-inputS" class="mdc-floating-label">Name</label>
                                                    </div>
